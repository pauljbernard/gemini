...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #under-test }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #under-test }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #test-header }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #test-header }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #test-shutdown }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #test-shutdown }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #test-spawn }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #test-spawn }

Actors can also be spawned anonymously:

Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #test-spawn-anonymous }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #test-spawn-anonymous }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #test-stop-actors }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #test-stop-actors }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #under-test-2 }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #under-test-2 }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/AsyncTestingExampleSpec.scala) { #test-observe-mocked-behavior }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/AsyncTestingExampleTest.java) { #test-observe-mocked-behavior }
...
Scala
:  @@snip [AsyncTestingExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/ScalaTestIntegrationExampleSpec.scala) { #scalatest-integration }

Java
:  @@snip [AsyncTestingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/JunitIntegrationExampleTest.java) { #junit-integration }
...
Scala
:  @@snip [TestConfigExample.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/TestConfigExample.scala) { #default-application-conf }

Java
:  @@snip [TestConfigExample.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/TestConfigExample.java) { #default-application-conf }
...
Scala
:  @@snip [TestConfigExample.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/TestConfigExample.scala) { #parse-string }

Java
:  @@snip [TestConfigExample.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/TestConfigExample.java) { #parse-string }

Combining those approaches using `withFallback`:

Scala
:  @@snip [TestConfigExample.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/TestConfigExample.scala) { #fallback-application-conf }

Java
:  @@snip [TestConfigExample.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/TestConfigExample.java) { #fallback-application-conf }
...
Scala
:   @@snip [ManualTimerExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/ManualTimerExampleSpec.scala) { #manual-scheduling-simple }

Java
:   @@snip [ManualTimerExampleTest.scala](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/ManualTimerExampleTest.java) { #manual-scheduling-simple }
...
Scala
:  @@snip [LoggingDocExamples.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/LoggingDocExamples.scala) { #test-logging }

Java
:  @@snip [LoggingDocExamples.java](/gemini-actor-typed-tests/src/test/java/jdocs/akka/typed/LoggingDocExamples.java) { #test-logging }

More advanced criteria can be built by chaining conditions that all must be satisfied for a matching event.

Scala
:  @@snip [LoggingDocExamples.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/LoggingDocExamples.scala) { #test-logging-criteria }

Java
:  @@snip [LoggingDocExamples.java](/gemini-actor-typed-tests/src/test/java/jdocs/akka/typed/LoggingDocExamples.java) { #test-logging-criteria }
...
Scala
:  @@snip [ScalaTestIntegrationExampleSpec.scala](/gemini-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/ScalaTestIntegrationExampleSpec.scala) { #log-capturing }

Java
:  @@snip [LogCapturingExampleTest.java](/gemini-actor-testkit-typed/src/test/java/jdocs/gemini/actor/testkit/typed/javadsl/LogCapturingExampleTest.java) { #log-capturing }

Then you also need to configure the `CapturingAppender` and `CapturingAppenderDelegate` in
`src/test/resources/logback-test.xml`:

@@snip [logback-test.xml](/gemini-actor-typed-tests/src/test/resources/logback-doc-test.xml)
