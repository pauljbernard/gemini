...
Scala
:   @@snip [SourceOperators.scala](/gemini-docs/src/test/scala/docs/stream/operators/SourceOperators.scala) { #maybe }

Java
:   @@snip [SourceDocExamples.java](/gemini-docs/src/test/java/jdocs/stream/operators/SourceDocExamples.java) { #maybe }
