...
Scala
:   @@snip [Throttle.scala](/gemini-docs/src/test/scala/docs/stream/operators/sourceorflow/Throttle.scala) { #throttle }

Java
:   @@snip [Throttle.java](/gemini-docs/src/test/java/jdocs/stream/operators/sourceorflow/Throttle.java) { #throttle }
...
Scala
:   @@snip [Throttle.scala](/gemini-docs/src/test/scala/docs/stream/operators/sourceorflow/Throttle.scala) { #throttle-with-burst }

Java
:   @@snip [Throttle.java](/gemini-docs/src/test/java/jdocs/stream/operators/sourceorflow/Throttle.java) { #throttle-with-burst }
