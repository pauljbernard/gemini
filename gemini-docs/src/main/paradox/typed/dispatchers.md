...
Scala
:  @@snip [DispatcherDocSpec.scala](/gemini-docs/src/test/scala/docs/actor/typed/DispatcherDocSpec.scala) { #lookup }

Java
:  @@snip [DispatcherDocTest.java](/gemini-docs/src/test/java/jdocs/actor/typed/DispatcherDocTest.java) { #lookup }
...
Scala
:  @@snip [DispatcherDocSpec.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/DispatchersDocSpec.scala) { #spawn-dispatcher }

Java
:  @@snip [DispatcherDocTest.java](/gemini-actor-typed-tests/src/test/java/jdocs/akka/typed/DispatchersDocTest.java) { #spawn-dispatcher }
...
@@snip [DispatcherDocSpec.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/DispatchersDocSpec.scala) { #config }
...
@@snip [DispatcherDocSpec.scala](/gemini-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala) { #my-dispatcher-config }
...
Scala
:   @@snip [BlockingDispatcherSample.scala](/gemini-docs/src/test/scala/docs/actor/typed/BlockingActor.scala) { #blocking-in-actor }

Java
:   @@snip [BlockingActor.java](/gemini-docs/src/test/java/jdocs/actor/typed/BlockingActor.java) { #blocking-in-actor }
...
Scala
:   @@snip [PrintActor.scala](/gemini-docs/src/test/scala/docs/actor/typed/PrintActor.scala) { #print-actor }

Java
:   @@snip [PrintActor.java](/gemini-docs/src/test/java/jdocs/actor/typed/PrintActor.java) { #print-actor }


Scala
:   @@snip [BlockingDispatcherSample.scala](/gemini-docs/src/test/scala/docs/actor/typed/BlockingDispatcherSample.scala) { #blocking-main }

Java
:   @@snip [BlockingDispatcherTest.java](/gemini-docs/src/test/java/jdocs/actor/typed/BlockingDispatcherTest.java) { #blocking-main }
...
Scala
:   @@snip [BlockingDispatcherSample.scala](/gemini-docs/src/test/scala/docs/actor/typed/BlockingDispatcherSample.scala) { #blocking-in-future }
...
<!--same config text for Scala & Java-->
@@snip [BlockingDispatcherSample.scala](/gemini-docs/src/test/scala/docs/actor/typed/BlockingDispatcherSample.scala) { #my-blocking-dispatcher-config }
...
Scala
:   @@snip [BlockingDispatcherSample.scala](/gemini-docs/src/test/scala/docs/actor/typed/BlockingDispatcherSample.scala) { #separate-dispatcher }

Java
:   @@snip [SeparateDispatcherCompletionStageActor.java](/gemini-docs/src/test/java/jdocs/actor/typed/SeparateDispatcherCompletionStageActor.java) { #separate-dispatcher }
...
@@snip [DispatcherDocSpec.scala](/gemini-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala) { #fixed-pool-size-dispatcher-config }
...
<!--same config text for Scala & Java-->
@@snip [DispatcherDocSpec.scala](/gemini-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala) {#my-thread-pool-dispatcher-config }
...
<!--same config text for Scala & Java-->
@@snip [DispatcherDocSpec.scala](/gemini-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala) {#my-pinned-dispatcher-config }
...
<!--same config text for Scala & Java-->
@@snip [DispatcherDocSpec.scala](/gemini-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala) {#my-dispatcher-with-timeouts-config }
