...
Scala
:  @@snip [IntroSpec.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/fromclassic/ClassicSample.scala) { #hello-world-actor }

Java
:  @@snip [IntroSpec.java](/gemini-actor-typed-tests/src/test/java/jdocs/akka/typed/fromclassic/ClassicSample.java) { #hello-world-actor }

Typed HelloWorld actor:

Scala
:  @@snip [IntroSpec.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/fromclassic/TypedSample.scala) { #hello-world-actor }

Java
:  @@snip [IntroSpec.java](/gemini-actor-typed-tests/src/test/java/jdocs/akka/typed/fromclassic/TypedSample.java) { #hello-world-actor }
...
Scala
:  @@snip [IntroSpec.scala](/gemini-actor-typed-tests/src/test/scala/docs/akka/typed/fromclassic/TypedSample.scala) { #children }

Java
:  @@snip [IntroSpec.java](/gemini-actor-typed-tests/src/test/java/jdocs/akka/typed/fromclassic/TypedSample.java) { #children }
