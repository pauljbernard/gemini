...
Scala
:   @@snip [Zip.scala](/gemini-docs/src/test/scala/docs/stream/operators/source/Zip.scala) { #zipN-simple }

Java
:   @@snip [Zip.java](/gemini-docs/src/test/java/jdocs/stream/operators/source/Zip.java) { #zipN-simple }
