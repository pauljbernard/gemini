...
Scala
:   @@snip[JavaFlowSupport.scala](/gemini-stream/src/main/scala-jdk-9/gemini/stream/scaladsl/JavaFlowSupport.scala) { #asSubscriber }

Java
:   @@snip[JavaFlowSupport.java](/gemini-docs/src/test/java-jdk9-only/jdocs/stream/operators/source/AsSubscriber.java) { #api }
...
Scala
:  @@snip [AsSubscriber.scala](/gemini-docs/src/test/scala-jdk9-only/docs/stream/operators/source/AsSubscriber.scala) { #imports #example }

Java
:  @@snip [AsSubscriber.java](/gemini-docs/src/test/java-jdk9-only/jdocs/stream/operators/source/AsSubscriber.java) { #imports #example }
