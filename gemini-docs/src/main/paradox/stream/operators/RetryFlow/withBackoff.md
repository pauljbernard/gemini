...
Scala
:   @@snip [RetryFlowSpec.scala](/gemini-stream-tests/src/test/scala/gemini/stream/scaladsl/RetryFlowSpec.scala) { #withBackoff-demo }

Java
:   @@snip [RetryFlowTest.java](/gemini-stream-tests/src/test/java/gemini/stream/javadsl/RetryFlowTest.java) { #withBackoff-demo }
