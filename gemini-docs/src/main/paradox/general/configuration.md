...
Scala
: @@snip [ConfigDocSpec.scala](/gemini-docs/src/test/scala/docs/config/ConfigDocSpec.scala) { #dump-config }

Java
: @@snip [ConfigDocTest.java](/gemini-docs/src/test/java/jdocs/config/ConfigDocTest.java) { #dump-config }
...
Scala
: @@snip [ConfigDocSpec.scala](/gemini-docs/src/test/scala/docs/config/ConfigDocSpec.scala) { #separate-apps }

Java
: @@snip [ConfigDocTest.java](/gemini-docs/src/test/java/jdocs/config/ConfigDocTest.java) { #separate-apps }
...
Scala
: @@snip [ConfigDocSpec.scala](/gemini-docs/src/test/scala/docs/config/ConfigDocSpec.scala) { #imports #custom-config }

Java
: @@snip [ConfigDocTest.java](/gemini-docs/src/test/java/jdocs/config/ConfigDocTest.java) { #imports #custom-config }
...
Scala
: @@snip [ConfigDocSpec.scala](/gemini-docs/src/test/scala/docs/config/ConfigDocSpec.scala) { #custom-config-2 }

Java
: @@snip [ConfigDocTest.java](/gemini-docs/src/test/java/jdocs/config/ConfigDocTest.java) { #custom-config-2 }
