...
Scala
:  @@snip [ShardedDaemonProcessExample.scala](/gemini-cluster-sharding-typed/src/test/scala/gemini/cluster/sharding/typed/scaladsl/ShardedDaemonProcessSpec.scala) { #tag-processing }

Java
:  @@snip [ShardedDaemonProcessExample.java](/gemini-cluster-sharding-typed/src/test/java/gemini/cluster/sharding/typed/javadsl/ShardedDaemonProcessCompileOnlyTest.java) { #tag-processing }
