...
Scala
:   @@snip [DeviceInProgress.scala](/gemini-docs/src/test/scala/typed/tutorial_3/DeviceInProgress.scala) { #read-protocol-1 }

Java
:   @@snip [Device.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/inprogress1/Device.java) { #read-protocol-1 }
...
Scala
:   @@snip [DeviceInProgress.scala](/gemini-docs/src/test/scala/typed/tutorial_3/DeviceInProgress.scala) { #read-protocol-2 }

Java
:   @@snip [Device.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/inprogress2/Device.java) { #read-protocol-2 }
...
Scala
:   @@snip [DeviceInProgress.scala](/gemini-docs/src/test/scala/typed/tutorial_3/DeviceInProgress.scala) { #device-with-read }

Java
:   @@snip [DeviceInProgress2.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/inprogress2/Device.java) { #device-with-read }
...
Scala
:   @@snip [DeviceSpec.scala](/gemini-docs/src/test/scala/typed/tutorial_3/DeviceSpec.scala) { #device-read-test }

Java
:   @@snip [DeviceTest.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/DeviceTest.java) { #device-read-test }
...
Scala
:   @@snip [DeviceInProgress.scala](/gemini-docs/src/test/scala/typed/tutorial_3/DeviceInProgress.scala) { #write-protocol-1 }

Java
:   @@snip [Device.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/inprogress3/Device.java) { #write-protocol-1 }
...
Scala
:   @@snip [DeviceInProgress.scala](/gemini-docs/src/test/scala/typed/tutorial_3/Device.scala) { #write-protocol }

Java
:   @@snip [Device.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/Device.java) { #write-protocol }
...
Scala
:  @@snip [Device.scala](/gemini-docs/src/test/scala/typed/tutorial_3/Device.scala) { #full-device }

Java
:  @@snip [Device.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/Device.java) { #full-device }

We should also write a new test case now, exercising both the read/query and write/record functionality together:

Scala:
:   @@snip [DeviceSpec.scala](/gemini-docs/src/test/scala/typed/tutorial_3/DeviceSpec.scala) { #device-write-read-test }

Java:
:   @@snip [DeviceTest.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_3/DeviceTest.java) { #device-write-read-test }
