...
Scala
:   @@snip [IotSupervisor.scala](/gemini-docs/src/test/scala/typed/tutorial_2/IotSupervisor.scala) { #iot-supervisor }

Java
:   @@snip [IotSupervisor.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_2/IotSupervisor.java) { #iot-supervisor }
...
Scala
:   @@snip [IotApp.scala](/gemini-docs/src/test/scala/typed/tutorial_2/IotApp.scala) { #iot-app }

Java
:   @@snip [IotMain.java](/gemini-docs/src/test/java/jdocs/typed/tutorial_2/IotMain.java) { #iot-app }
