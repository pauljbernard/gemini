...
Scala
:  @@snip [FactorialBackend.scala](/gemini-docs/src/test/scala/docs/cluster/FactorialBackend.scala) { #backend }

Java
:  @@snip [FactorialBackend.java](/gemini-docs/src/test/java/jdocs/cluster/FactorialBackend.java) { #backend }

The frontend that receives user jobs and delegates to the backends via the router:

Scala
:  @@snip [FactorialFrontend.scala](/gemini-docs/src/test/scala/docs/cluster/FactorialFrontend.scala) { #frontend }

Java
:  @@snip [FactorialFrontend.java](/gemini-docs/src/test/java/jdocs/cluster/FactorialFrontend.java) { #frontend }
...
Scala
:  @@snip [FactorialFrontend.scala](/gemini-docs/src/test/scala/docs/cluster/FactorialFrontend.scala) { #router-lookup-in-code #router-deploy-in-code }

Java
:  @@snip [FactorialFrontend.java](/gemini-docs/src/test/java/jdocs/cluster/FactorialFrontend.java) { #router-lookup-in-code #router-deploy-in-code }
...
Scala
:  @@snip [MetricsListener.scala](/gemini-docs/src/test/scala/docs/cluster/MetricsListener.scala) { #metrics-listener }

Java
:  @@snip [MetricsListener.java](/gemini-docs/src/test/java/jdocs/cluster/MetricsListener.java) { #metrics-listener }
