...
Scala
: @@snip [SharedMutableStateDocSpec.scala](/gemini-docs/src/test/scala/docs/actor/typed/SharedMutableStateDocSpec.scala) { #mutable-state }

Java
: @@snip [DistributedDataDocTest.java](/gemini-docs/src/test/java/jdocs/actor/typed/SharedMutableStateDocTest.java) { #mutable-state }
