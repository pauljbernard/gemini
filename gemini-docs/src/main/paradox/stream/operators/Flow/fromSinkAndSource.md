...
Scala
:   @@snip [FromSinkAndSource.scala](/gemini-docs/src/test/scala/docs/stream/operators/flow/FromSinkAndSource.scala) { #halfClosedTcpServer }

Java
:   @@snip [FromSinkAndSource.java](/gemini-docs/src/test/java/jdocs/stream/operators/flow/FromSinkAndSource.java) { #halfClosedTcpServer }
...
Scala
:   @@snip [FromSinkAndSource.scala](/gemini-docs/src/test/scala/docs/stream/operators/flow/FromSinkAndSource.scala) { #chat }

Java
:   @@snip [FromSinkAndSource.java](/gemini-docs/src/test/java/jdocs/stream/operators/flow/FromSinkAndSource.java) { #chat }
...
Scala
:   @@snip [FromSinkAndSource.scala](/gemini-docs/src/test/scala/docs/stream/operators/flow/FromSinkAndSource.scala) { #testing }

Java
:   @@snip [FromSinkAndSource.java](/gemini-docs/src/test/java/jdocs/stream/operators/flow/FromSinkAndSource.java) { #testing }
