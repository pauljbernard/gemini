...
Scala
:  @@snip [EventBus.scala](/gemini-actor/src/main/scala/gemini/event/EventBus.scala) { #event-bus-api }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #event-bus-api }
...
Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #lookup-bus }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #lookup-bus }

A test for this implementation may look like this:

Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #lookup-bus-test }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #lookup-bus-test }
...
Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #subchannel-bus }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #subchannel-bus }

A test for this implementation may look like this:

Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #subchannel-bus-test }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #subchannel-bus-test }
...
Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #scanning-bus }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #scanning-bus }

A test for this implementation may look like this:

Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #scanning-bus-test }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #scanning-bus-test }
...
Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #actor-bus }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #actor-bus }

A test for this implementation may look like this:

Scala
:  @@snip [EventBusDocSpec.scala](/gemini-docs/src/test/scala/docs/event/EventBusDocSpec.scala) { #actor-bus-test }

Java
:  @@snip [EventBusDocTest.java](/gemini-docs/src/test/java/jdocs/event/EventBusDocTest.java) { #actor-bus-test }
...
@@snip [LoggingDocSpec.scala](/gemini-docs/src/test/scala/docs/event/LoggingDocSpec.scala) { #deadletters }

@@@

@@@ div { .group-java }

@@snip [LoggingDocTest.java](/gemini-docs/src/test/java/jdocs/event/LoggingDocTest.java) { #imports-deadletter }

@@snip [LoggingDocTest.java](/gemini-docs/src/test/java/jdocs/event/LoggingDocTest.java) { #deadletter-actor }

it can be subscribed like this:

@@snip [LoggingDocTest.java](/gemini-docs/src/test/java/jdocs/event/LoggingDocTest.java) { #deadletters }
...
Scala
:  @@snip [LoggingDocSpec.scala](/gemini-docs/src/test/scala/docs/event/LoggingDocSpec.scala) { #superclass-subscription-eventstream }

Java
:  @@snip [LoggingDocTest.java](/gemini-docs/src/test/java/jdocs/event/LoggingDocTest.java) { #superclass-subscription-eventstream }
...
Scala
:  @@snip [LoggingDocSpec.scala](/gemini-docs/src/test/scala/docs/event/LoggingDocSpec.scala) { #suppressed-deadletters }

Java
:  @@snip [LoggingDocTest.java](/gemini-docs/src/test/java/jdocs/event/LoggingDocTest.java) { #suppressed-deadletters }

or all dead letters (including the suppressed ones):

Scala
:  @@snip [LoggingDocSpec.scala](/gemini-docs/src/test/scala/docs/event/LoggingDocSpec.scala) { #all-deadletters }

Java
:  @@snip [LoggingDocTest.java](/gemini-docs/src/test/java/jdocs/event/LoggingDocTest.java) { #all-deadletters }
