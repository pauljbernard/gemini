...
@@snip [reference.conf](/gemini-cluster/src/main/resources/reference.conf) { #split-brain-resolver }
...
@@snip [reference.conf](/gemini-cluster/src/main/resources/reference.conf) { #keep-majority }
...
@@snip [reference.conf](/gemini-cluster/src/main/resources/reference.conf) { #static-quorum }
...
@@snip [reference.conf](/gemini-cluster/src/main/resources/reference.conf) { #keep-oldest }
...
@@snip [reference.conf](/gemini-cluster/src/main/resources/reference.conf) { #lease-majority }
