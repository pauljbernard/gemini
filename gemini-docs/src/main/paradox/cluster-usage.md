...
Scala
:  @@snip [SimpleClusterListener.scala](/gemini-docs/src/test/scala/docs/cluster/SimpleClusterListener.scala) { type=scala }

Java
:  @@snip [SimpleClusterListener.java](/gemini-docs/src/test/java/jdocs/cluster/SimpleClusterListener.java) { type=java }

And the minimum configuration required is to set a host/port for remoting and the `akka.actor.provider = "cluster"`.

@@snip [BasicClusterExampleSpec.scala](/gemini-cluster-typed/src/test/scala/docs/akka/cluster/typed/BasicClusterExampleSpec.scala) { #config-seeds }
...
Scala
:  @@snip [ClusterDocSpec.scala](/gemini-docs/src/test/scala/docs/cluster/ClusterDocSpec.scala) { #join-seed-nodes }

Java
:  @@snip [ClusterDocTest.java](/gemini-docs/src/test/java/jdocs/cluster/ClusterDocTest.java) { #join-seed-nodes-imports #join-seed-nodes }
...
Scala
:  @@snip [SimpleClusterListener2.scala](/gemini-docs/src/test/scala/docs/cluster/SimpleClusterListener2.scala) { #join }

Java
:  @@snip [SimpleClusterListener2.java](/gemini-docs/src/test/java/jdocs/cluster/SimpleClusterListener2.java) { #join }
...
Scala
:  @@snip [SimpleClusterListener2.scala](/gemini-docs/src/test/scala/docs/cluster/SimpleClusterListener2.scala) { #subscribe }

Java
:  @@snip [SimpleClusterListener2.java](/gemini-docs/src/test/java/jdocs/cluster/SimpleClusterListener2.java) { #subscribe }
...
Scala
:  @@snip [SimpleClusterListener2.scala](/gemini-docs/src/test/scala/docs/cluster/SimpleClusterListener2.scala) { #join #subscribe }

Java
:  @@snip [SimpleClusterListener2.java](/gemini-docs/src/test/java/jdocs/cluster/SimpleClusterListener2.java) { #join #subscribe }
...
Scala
:  @@snip [SimpleClusterListener2.scala](/gemini-docs/src/test/scala/docs/cluster/SimpleClusterListener2.scala) { #join #register-on-memberup }

Java
:  @@snip [SimpleClusterListener2.java](/gemini-docs/src/test/java/jdocs/cluster/SimpleClusterListener2.java) { #join #register-on-memberup }
...
Scala
:  @@snip [SimpleClusterListener.scala](/gemini-docs/src/test/scala/docs/cluster/SimpleClusterListener.scala) { #subscribe }

Java
:  @@snip [SimpleClusterListener.java](/gemini-docs/src/test/java/jdocs/cluster/SimpleClusterListener.java) { #subscribe }
...
Scala
:  @@snip [TransformationMessages.scala](/gemini-docs/src/test/scala/docs/cluster/TransformationMessages.scala) { #messages }

Java
:  @@snip [TransformationMessages.java](/gemini-docs/src/test/java/jdocs/cluster/TransformationMessages.java) { #messages }

The backend worker that performs the transformation job:

Scala
:  @@snip [TransformationBackend.scala](/gemini-docs/src/test/scala/docs/cluster/TransformationBackend.scala) { #backend }

Java
:  @@snip [TransformationBackend.java](/gemini-docs/src/test/java/jdocs/cluster/TransformationBackend.java) { #backend }
...
Scala
:  @@snip [TransformationFrontend.scala](/gemini-docs/src/test/scala/docs/cluster/TransformationFrontend.scala) { #frontend }

Java
:  @@snip [TransformationFrontend.java](/gemini-docs/src/test/java/jdocs/cluster/TransformationFrontend.java) { #frontend }
...
Scala
:  @@snip [FactorialFrontend.scala](/gemini-docs/src/test/scala/docs/cluster/FactorialFrontend.scala) { #registerOnUp }

Java
:  @@snip [FactorialFrontendMain.java](/gemini-docs/src/test/java/jdocs/cluster/FactorialFrontendMain.java) { #registerOnUp }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #MultiNodeConfig }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #concrete-tests }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #abstract-test }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #startup-cluster }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #join }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #test-statsService }
...
@@snip [StatsSampleSpec.scala](/gemini-cluster-metrics/src/multi-jvm/scala/gemini/cluster/metrics/sample/StatsSampleSpec.scala) { #addresses }
