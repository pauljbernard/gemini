...
Scala
:  @@snip [CircuitBreakerDocSpec.scala](/gemini-docs/src/test/scala/docs/circuitbreaker/CircuitBreakerDocSpec.scala) { #imports1 #circuit-breaker-initialization }

Java
:  @@snip [DangerousJavaActor.java](/gemini-docs/src/test/java/jdocs/circuitbreaker/DangerousJavaActor.java) { #imports1 #circuit-breaker-initialization }
...
Scala
: @@snip [CircuitBreakerDocSpec.scala](/gemini-docs/src/test/scala/docs/circuitbreaker/CircuitBreakerDocSpec.scala) { #circuit-breaker-usage }

Java
:  @@snip [DangerousJavaActor.java](/gemini-docs/src/test/java/jdocs/circuitbreaker/DangerousJavaActor.java) { #circuit-breaker-usage }
...
Scala
:  @@snip [CircuitBreakerDocSpec.scala](/gemini-docs/src/test/scala/docs/circuitbreaker/CircuitBreakerDocSpec.scala) { #even-no-as-failure }

Java
:  @@snip [EvenNoFailureJavaExample.java](/gemini-docs/src/test/java/jdocs/circuitbreaker/EvenNoFailureJavaExample.java) { #even-no-as-failure }
...
Scala
:  @@snip [CircuitBreakerDocSpec.scala](/gemini-docs/src/test/scala/docs/circuitbreaker/CircuitBreakerDocSpec.scala) { #circuit-breaker-tell-pattern }

Java
:  @@snip [TellPatternJavaActor.java](/gemini-docs/src/test/java/jdocs/circuitbreaker/TellPatternJavaActor.java) { #circuit-breaker-tell-pattern }
