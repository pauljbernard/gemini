...
Java
:   @@snip [SourceDocExamples.java](/gemini-docs/src/test/java/jdocs/stream/operators/SourceDocExamples.java) { #range-imports #range }

Print out the stream of integers.

Java
:   @@snip [SourceDocExamples.java](/gemini-docs/src/test/java/jdocs/stream/operators/SourceDocExamples.java) { #run-range}
