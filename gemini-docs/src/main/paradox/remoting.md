...
Scala
:   @@snip [RemoteDeploymentDocSpec.scala](/gemini-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala) { #sample-actor }

Java
:   @@snip [RemoteDeploymentDocTest.java](/gemini-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java) { #sample-actor }
...
Scala
:   @@snip [RemoteDeploymentDocSpec.scala](/gemini-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala) { #import }

Java
:   @@snip [RemoteDeploymentDocTest.java](/gemini-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java) { #import }

and a remote address like this:

Scala
:   @@snip [RemoteDeploymentDocSpec.scala](/gemini-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala) { #make-address }

Java
:   @@snip [RemoteDeploymentDocTest.java](/gemini-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java) { #make-address }

you can advise the system to create a child on that remote node like so:

Scala
:   @@snip [RemoteDeploymentDocSpec.scala](/gemini-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala) { #deploy }

Java
:   @@snip [RemoteDeploymentDocTest.java](/gemini-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java) { #deploy }
...
@@snip [RemoteDeploymentAllowListSpec.scala](/gemini-remote/src/test/scala/gemini/remote/classic/RemoteDeploymentAllowListSpec.scala) { #allow-list-config }
...
@@snip [RouterDocSpec.scala](/gemini-docs/src/test/scala/docs/routing/RouterDocSpec.scala) { #config-remote-round-robin-pool }
...
@@snip [RouterDocSpec.scala](/gemini-docs/src/test/scala/docs/routing/RouterDocSpec.scala) { #config-remote-round-robin-group }
...
@@snip [RemoteDeploymentDocTest.java](/gemini-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java) { #programmatic }
