...
Scala
:  @@snip [BasicClusterExampleSpec.scala](/gemini-cluster-typed/src/test/scala/docs/akka/cluster/typed/BasicClusterExampleSpec.scala) { #dcAccess }

Java
:  @@snip [BasicClusterExampleTest.java](/gemini-cluster-typed/src/test/java/jdocs/akka/cluster/typed/BasicClusterExampleTest.java) { #dcAccess }
...
Scala
:  @@snip [SingletonCompileOnlySpec.scala](/gemini-cluster-typed/src/test/scala/docs/akka/cluster/typed/SingletonCompileOnlySpec.scala) { #create-singleton-proxy-dc }

Java
:  @@snip [SingletonCompileOnlyTest.java](/gemini-cluster-typed/src/test/java/jdocs/akka/cluster/typed/SingletonCompileOnlyTest.java) { #create-singleton-proxy-dc }
...
Scala
:  @@snip [MultiDcClusterShardingSpec.scala](/gemini-cluster-sharding-typed/src/multi-jvm/scala/gemini/cluster/sharding/typed/MultiDcClusterShardingSpec.scala) { #proxy-dc }

Java
:  @@snip [ShardingCompileOnlyTest.java](/gemini-cluster-sharding-typed/src/test/java/jdocs/akka/cluster/sharding/typed/ShardingCompileOnlyTest.java) { #proxy-dc }

and it can also be used with an `EntityRef`:

Scala
:  @@snip [MultiDcClusterShardingSpec.scala](/gemini-cluster-sharding-typed/src/multi-jvm/scala/gemini/cluster/sharding/typed/MultiDcClusterShardingSpec.scala) { #proxy-dc-entityref }

Java
:  @@snip [ShardingCompileOnlyTest.java](/gemini-cluster-sharding-typed/src/test/java/jdocs/akka/cluster/sharding/typed/ShardingCompileOnlyTest.java) { #proxy-dc-entityref }
