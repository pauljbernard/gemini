...
Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #counter-actor }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #counter-actor }
...
Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #counter-start }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #counter-start }
...
Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #counter-extractor }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #counter-extractor }
...
Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #counter-usage }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #counter-usage }
...
Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #extractShardId-StartEntity }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #extractShardId-StartEntity }
...
Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #supervisor }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #supervisor }

You start such a supervisor in the same way as if it was the entity actor.

Scala
:  @@snip [ClusterShardingSpec.scala](/gemini-cluster-sharding/src/multi-jvm/scala/gemini/cluster/sharding/ClusterShardingSpec.scala) { #counter-supervisor-start }

Java
:  @@snip [ClusterShardingTest.java](/gemini-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java) { #counter-supervisor-start }
