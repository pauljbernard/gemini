...
Scala
:  @@snip [ClusterClientSpec.scala](/gemini-cluster-tools/src/multi-jvm/scala/gemini/cluster/client/ClusterClientSpec.scala) { #server }

Java
:  @@snip [ClusterClientTest.java](/gemini-cluster-tools/src/test/java/gemini/cluster/client/ClusterClientTest.java) { #server }
...
Scala
:  @@snip [ClusterClientSpec.scala](/gemini-cluster-tools/src/multi-jvm/scala/gemini/cluster/client/ClusterClientSpec.scala) { #client }

Java
:  @@snip [ClusterClientTest.java](/gemini-cluster-tools/src/test/java/gemini/cluster/client/ClusterClientTest.java) { #client }

The `initialContacts` parameter is a @scala[`Set[ActorPath]`]@java[`Set<ActorPath>`], which can be created like this:

Scala
:  @@snip [ClusterClientSpec.scala](/gemini-cluster-tools/src/multi-jvm/scala/gemini/cluster/client/ClusterClientSpec.scala) { #initialContacts }

Java
:  @@snip [ClusterClientTest.java](/gemini-cluster-tools/src/test/java/gemini/cluster/client/ClusterClientTest.java) { #initialContacts }
...
Scala
:  @@snip [ClusterClientSpec.scala](/gemini-cluster-tools/src/multi-jvm/scala/gemini/cluster/client/ClusterClientSpec.scala) { #clientEventsListener }

Java
:  @@snip [ClusterClientTest.java](/gemini-cluster-tools/src/test/java/gemini/cluster/client/ClusterClientTest.java) { #clientEventsListener }
...
Scala
:  @@snip [ClusterClientSpec.scala](/gemini-cluster-tools/src/multi-jvm/scala/gemini/cluster/client/ClusterClientSpec.scala) { #receptionistEventsListener }

Java
:  @@snip [ClusterClientTest.java](/gemini-cluster-tools/src/test/java/gemini/cluster/client/ClusterClientTest.java) { #receptionistEventsListener }
...
@@snip [reference.conf](/gemini-cluster-tools/src/main/resources/reference.conf) { #receptionist-ext-config }
...
@@snip [reference.conf](/gemini-cluster-tools/src/main/resources/reference.conf) { #cluster-client-config }
